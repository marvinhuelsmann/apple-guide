                                ...
                                <div className="relative mt-1">
                                    <div
                                        ...
                                        <Combobox.Input
                                            ...
                                            className="autofocus w-full py-2 pl-5 pr-10 text-md leading-5 bg-transparent place-holder-blue-400 text-center border w-full border-transparent focus:outline-none text-black text-5xl font-bold placeholder:font-medium rounded-lg focus:ring-transparent focus:border-transparent block"
